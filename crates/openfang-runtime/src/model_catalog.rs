...
fn builtin_models() -> Vec<ModelCatalogEntry> {
    vec![
        ...
        // ══════════════════════════════════════════════════════════════
        // Copilot CLI (5) — subprocess-based
        // ══════════════════════════════════════════════════════════════
        ModelCatalogEntry {
            id: "copilot-cli/gpt-5.4".into(),
            display_name: "Copilot GPT-5.4".into(),
            ...
            supports_vision: false,
            supports_streaming: true,
            aliases: vec!["copilot-gpt-5.4".into(), "gpt-5.4".into()],
        },
        ModelCatalogEntry {
            id: "copilot-cli/gpt-5.3-codex".into(),
            display_name: "Copilot GPT-5.3 Codex".into(),
            provider: "copilot-cli".into(),
            tier: ModelTier::Frontier,
            context_window: 128_000,
            max_output_tokens: 16_384,
            ...
            supports_vision: false,
            supports_streaming: true,
            aliases: vec!["gpt-5.3-codex".into()],
        },
        ModelCatalogEntry {
            id: "copilot-cli/gpt-5.2-codex".into(),
            display_name: "Copilot GPT-5.2 Codex".into(),
            provider: "copilot-cli".into(),
            tier: ModelTier::Smart,
            context_window: 128_000,
            max_output_tokens: 16_384,
            ...
            supports_vision: false,
            supports_streaming: true,
            aliases: vec!["gpt-5.2-codex".into()],
        },
        ModelCatalogEntry {
            id: "copilot-cli/gpt-5.2".into(),
            display_name: "Copilot GPT-5.2".into(),
            provider: "copilot-cli".into(),
            tier: ModelTier::Smart,
            context_window: 128_000,
            max_output_tokens: 16_384,
            ...
            supports_vision: false,
            supports_streaming: true,
            aliases: vec!["gpt-5.2".into()],
        },
        ModelCatalogEntry {
            id: "copilot-cli/gpt-4.1".into(),
            display_name: "Copilot GPT-4.1".into(),
            provider: "copilot-cli".into(),
            tier: ModelTier::Smart,
            context_window: 128_000,
            max_output_tokens: 16_384,
            ...
            supports_vision: false,
            supports_streaming: true,
            aliases: vec!["copilot-gpt-4.1".into(), "gpt-4.1".into()],
        },
        ModelCatalogEntry {
            id: "copilot-cli/claude-sonnet-4.6".into(),
            display_name: "Copilot Sonnet 4.6".into(),
            provider: "copilot-cli".into(),
            tier: ModelTier::Frontier,
            context_window: 200_000,
            max_output_tokens: 8_192,
            ...
            supports_vision: false,
            supports_streaming: true,
            aliases: vec!["copilot-sonnet-4.6".into()],
        },
        ModelCatalogEntry {
            id: "copilot-cli/claude-opus-4.6".into(),
            display_name: "Copilot Opus 4.6".into(),
            provider: "copilot-cli".into(),
            tier: ModelTier::Frontier,
            context_window: 200_000,
            max_output_tokens: 4_096,
            ...
            supports_vision: false,
            supports_streaming: true,
            aliases: vec!["copilot-opus-4.6".into()],
        },
        ModelCatalogEntry {
            id: "copilot-cli/claude-opus-4.6-fast".into(),
            display_name: "Copilot Opus 4.6 Fast".into(),
            provider: "copilot-cli".into(),
            tier: ModelTier::Frontier,
            context_window: 200_000,
            max_output_tokens: 4_096,
            ...
            supports_vision: false,
            supports_streaming: true,
            aliases: vec!["copilot-opus-4.6-fast".into()],
        },
        ModelCatalogEntry {
            id: "copilot-cli/claude-opus-4.5".into(),
            display_name: "Copilot Opus 4.5".into(),
            provider: "copilot-cli".into(),
            tier: ModelTier::Frontier,
            context_window: 200_000,
            max_output_tokens: 4_096,
            ...
            supports_vision: false,
            supports_streaming: true,
            aliases: vec!["copilot-opus-4.5".into()],
        },
        ModelCatalogEntry {
            id: "copilot-cli/claude-sonnet-4".into(),
            display_name: "Copilot Sonnet 4".into(),
            provider: "copilot-cli".into(),
            tier: ModelTier::Frontier,
            context_window: 200_000,
            max_output_tokens: 4_096,
            ...
            supports_vision: false,
            supports_streaming: true,
            aliases: vec!["copilot-sonnet-4".into()],
        },
        ModelCatalogEntry {
            id: "copilot-cli/claude-sonnet-4.5".into(),
            display_name: "Copilot Sonnet 4.5".into(),
            provider: "copilot-cli".into(),
            tier: ModelTier::Frontier,
            context_window: 200_000,
            max_output_tokens: 8_192,
            ...
            supports_vision: false,
            supports_streaming: true,
            aliases: vec!["copilot-sonnet-4.5".into()],
        },
        ModelCatalogEntry {
            id: "copilot-cli/claude-haiku-4.5".into(),
            display_name: "Copilot Haiku 4.5".into(),
            provider: "copilot-cli".into(),
            tier: ModelTier::Fast,
            context_window: 200_000,
            max_output_tokens: 8_192,
            ...
            supports_vision: false,
            supports_streaming: true,
            aliases: vec!["copilot-haiku-4.5".into()],
        },
        ModelCatalogEntry {
            id: "copilot-cli/gemini-3-pro-preview".into(),
            display_name: "Copilot Gemini 3 Pro".into(),
            provider: "copilot-cli".into(),
            tier: ModelTier::Frontier,
            context_window: 200_000,
            max_output_tokens: 8_192,
            ...
            supports_vision: false,
            supports_streaming: true,
            aliases: vec!["copilot-gemini-3".into()],
        },
        ModelCatalogEntry {
            id: "copilot-cli/gpt-5.1-codex-max".into(),
            display_name: "Copilot GPT-5.1 Codex Max".into(),
            provider: "copilot-cli".into(),
            tier: ModelTier::Frontier,
            context_window: 128_000,
            max_output_tokens: 16_384,
            ...
            supports_vision: false,
            supports_streaming: true,
            aliases: vec!["gpt-5.1-codex-max".into()],
        },
        ModelCatalogEntry {
            id: "copilot-cli/gpt-5.1-codex".into(),
            display_name: "Copilot GPT-5.1 Codex".into(),
            provider: "copilot-cli".into(),
            tier: ModelTier::Smart,
            context_window: 128_000,
            max_output_tokens: 16_384,
            ...
            supports_vision: false,
            supports_streaming: true,
            aliases: vec!["gpt-5.1-codex".into()],
        },
        ModelCatalogEntry {
            id: "copilot-cli/gpt-5.1-codex-mini".into(),
            display_name: "Copilot GPT-5.1 Codex Mini".into(),
            provider: "copilot-cli".into(),
            tier: ModelTier::Fast,
            context_window: 128_000,
            max_output_tokens: 16_384,
            ...
            supports_vision: false,
            supports_streaming: true,
            aliases: vec!["gpt-5.1-codex-mini".into()],
        },
        ModelCatalogEntry {
            id: "copilot-cli/gpt-5-mini".into(),
            display_name: "Copilot GPT-5 Mini".into(),
            provider: "copilot-cli".into(),
            tier: ModelTier::Fast,
            context_window: 128_000,
            max_output_tokens: 16_384,
            ...
            supports_vision: false,
            supports_streaming: true,
            aliases: vec!["gpt-5-mini".into()],
        },
        ModelCatalogEntry {
            id: "copilot-cli/gpt-5.1".into(),
            display_name: "Copilot GPT-5.1".into(),
            provider: "copilot-cli".into(),
            tier: ModelTier::Smart,
            context_window: 128_000,
            max_output_tokens: 8_192,
            ...
            supports_vision: false,
            supports_streaming: true,
            aliases: vec!["copilot-gpt-5.1".into()],
        },
        // ══════════════════════════════════════════════════════════════
